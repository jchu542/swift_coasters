...
#$mon++;
#my $LOG = "/stage/swift-coasters/swift_coasters/logs/0$mon$mday$hour/worker-0$mon$mday$hour.log";
#my $LOG = "/stage/swift-coasters/swift_coasters/logs/052400/worker-052400.log";
#my $LOG = "/home/jchu542/logs/0$mon$mday$hour/worker-0$mon$mday$hour.log";
#my $LOG = "/home/jchu542/logs/051300/worker-051300.log";
my $LOG = "/stage/swift-coasters/swift_coasters/logs/worker.log";
...
sub unpackData {
	...
	while ($alen < $len) {
		...
		if(length($frag)>0) {wlog(TRACE, " FRAG: $frag\n");}	
